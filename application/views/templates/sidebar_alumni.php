    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-hmif-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item btn-nero">
                <a class="nav-link" href="<?php echo base_url('alumni/home') ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item btn-nero">
                <a class="nav-link" href="<?php echo base_url('alumni/anggota') ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item btn-nero">
                <a class="nav-link" href="<?php echo base_url('alumni/proker') ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item btn-nero">
                <a class="nav-link" href="<?php echo base_url('alumni/birthday') ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <?php echo anchor('alumni/home/lihat_pengurus/'.$anggota['nim'], '<div class="dropdown-item"><i class="fas fa-user-edit fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Kepengurusan</div>'); ?>
