    ...
    <div class="container-fluid">
      <nav aria-label="breadcrumb">
            <ol class="breadcrumb" style="background: tomatoes;">
              ...
              <li class="breadcrumb-item active" aria-current="page">Tahun Divisi</li>
            </ol>
        </nav>
      <div class="row">
      <div class="col-lg-12">
          ...
          <div class="card mb-4 py-3 border-bottom-primary">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <?php if($anggota['user_level'] == 1){ ?>
                  <?=anchor('admin/anggota/detail_divisi/'.$th->tahun."/".$div['id_divisi'],$a,array("rel" => "bookmark", 'class'=>'btn btn-primary btn-icon-split btn-lg center pilihan'));?>
                <?php } elseif($anggota['user_level'] == 2) {?>
                  <?=anchor('member/anggota/detail_divisi/'.$th->tahun."/".$div['id_divisi'],$a,array("rel" => "bookmark", 'class'=>'btn btn-primary btn-icon-split btn-lg center'));?>
                <?php } elseif($anggota['user_level'] == 3) {?>
                  <?=anchor('alumni/anggota/detail_divisi/'.$th->tahun."/".$div['id_divisi'],$a,array("rel" => "bookmark", 'class'=>'btn btn-primary btn-icon-split btn-lg center'));?>
                <?php } ?>
                <br /><br />
              <?php   endforeach; ?>
              </div>
